...
func TestAllScopesAreDistinct(t *testing.T) {
	...
	for _, required := range []string{ScopeLinksRead, ScopeLinksWrite, ScopeStatsRead, ScopeTokensManage, ScopeAuditRead, ScopeUsersManage, ScopeRolesManage, ScopeOIDCManage, ScopeAnalyticsManage, ScopeCaptchaManage} {
		if !seen[required] {
...
func TestDefaultTokenScopesExcludeAdministration(t *testing.T) {
	for _, forbidden := range []string{ScopeTokensManage, ScopeAuditRead, ScopeUsersManage, ScopeRolesManage, ScopeOIDCManage, ScopeAnalyticsManage, ScopeCaptchaManage} {
