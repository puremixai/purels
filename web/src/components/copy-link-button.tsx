...
export function CopyLinkButton({ value }: { value: string }) {
  ...
  return (
    <button
      ...
      onClick={copy}
      aria-live="polite"
      className="group flex min-h-14 w-full items-center justify-between gap-4 rounded-[var(--radius-control)] border border-[var(--line-strong)] bg-[var(--surface)] px-4 py-3 text-left transition hover:border-[var(--brand)] hover:bg-[var(--canvas-alt)]"
    >
